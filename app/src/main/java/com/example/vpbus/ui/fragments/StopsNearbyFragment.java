...
public class StopsNearbyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_stops_nearby, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.recyclerNearbyStops);
        emptyText = view.findViewById(R.id.textEmptyNearby);
    ...
    public void refresh() {
        ...
        List<BusStop> stops = stopsDataProvider.getNearbyStops();
